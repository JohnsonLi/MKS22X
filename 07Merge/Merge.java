...
public class Merge{
    ...
    public static void merge2(int[] ary, int[] temp, int left, int right){
    ...
    public static void mergesort2(int[] ary){
        mergesortH2(ary, new int[ary.length] ,0 ,ary.length - 1);
    }

    public static void mergesortH2(int[] ary, int[] temp, int start, int end){
        // if(start >= end){
        //     return;
        // }
        int mid = (start + end) / 2;
        ...
        if(end > start){
            ...
            mergesortH2(temp, ary, start, mid);
            mergesortH2(temp, ary, mid + 1, end);
            merge2(ary, temp, start, end);
        }
    }
